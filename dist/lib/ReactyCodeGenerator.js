...
var ReactyCodeGenerator = /** @class */ (function () {
    ...
    ReactyCodeGenerator.prototype.generate = function () {
        ...
        var l = this.library;
        return "\nimport * as ".concat(this.library.getFactoryFunctionName(), " from \"").concat(this.library.getName(), "\";\nimport type { ComponentType } from \"").concat(this.library.getName(), "\";").concat(additionalImports, "\n\n").concat(l.getBeforComponentDeclarationCode(), "\n\nexport const ").concat(component.getName(), ": ComponentType").concat(l.getGenericAfterExtend(), " = (").concat(l.getRenderArguments(), ") => {\n  \n    ").concat(l.getBeforeRenderReturnCode(), "\n      \n    return (\n      ").concat(jsx, "\n    );  \n}\n");
    };
